...
interface TournamentDetailMobileProps {
  tournament: Tournament;
  matches: Match[];
}

export default function TournamentDetailMobile({
  tournament,
  matches,
}: TournamentDetailMobileProps) {
  ...
  return (
    <div className="bg-linear-to-b from-deep-blue-light from-20% to-cool-gray   min-h-screen pb-[185px] sm:pb-[80px] md:pb-4 lg:pb-6  ">
                      ...
                      {(["1", "X", "2"] as const).map((betOption) => (
                        <li key={betOption}>
                          <button
                            ...
                            className={` w-full px-6 md:px-3 lg:px-4 py-[3px] sm:py-2 md:py-2.5 rounded-lg cursor-pointer transition-all duration-200 text-center   ${
