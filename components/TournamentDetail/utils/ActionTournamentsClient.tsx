  ...
  return (
    <div className=" fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 md:sticky md:bottom-0 md:left-auto md:right-auto md:border md:border-gray-200 md:rounded-lg md:shadow-sm md:px-4 md:pt-4 md:pb-4 md:z-10 md:mt-6 shadow-custom">
      <div className="px-4 pt-4 pb-2 md:px-0 md:pt-0">
        <div className="flex flex-col items-center justify-between bg-gray-50 rounded-lg p-3 md:p-4 w-full">
          <div className="flex items-center justify-between gap-2 md:gap-3 w-full text-xs md:text-sm">
            <div className="flex ">
              <svg
                viewBox="0 0 24 24"
          ...
          <div className="text-left flex items-center justify-between w-full">
            <div className=" text-gray-600">ضریب خط</div>
            <div className="text-lg md:text-xl font-bold text-deep-blue">
              {line_coefficient}
            </div>
          </div>
          {/* totalLines */}
          <div className="text-left flex items-center justify-between w-full">
            <div className=" text-gray-600">تعداد خطوط</div>
            <div className="text-lg md:text-xl font-bold text-deep-blue">
              {totalLines}
            </div>
          </div>
